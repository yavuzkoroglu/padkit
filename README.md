...
ln -sF $(echo $(brew --prefix gcc)/bin/gcc-[0-9]* | tr ' ' '\n' | sort -rV | head -1) $(brew --prefix)/bin/gcc
ln -sF $(echo $(brew --prefix llvm)/bin/clang-[0-9]* | tr ' ' '\n' | sort -rV | head -1) $(brew --prefix)/bin/clang
