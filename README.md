...
ln -sF $(find $(brew --prefix gcc)/bin/gcc-[0-9]* -maxdepth 0 | sort -V | tail -1) $(brew --prefix)/bin/gcc
ln -sF $(find $(brew --prefix llvm)/bin/clang-[0-9]* -maxdepth 0 | sort -V | tail -1) $(brew --prefix)/bin/clang
