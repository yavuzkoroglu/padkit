...
static bool test_arraylist_setFirst_alist(void);
static bool test_arraylist_setFirstN_alist(void);
static bool test_arraylist_setFirstSameN_alist(void);
static bool test_arraylist_setLast_alist(void);
static bool test_arraylist_setLastN_alist(void);
static bool test_arraylist_setLastSameN_alist(void);
...
static bool test_arraylist_vconstruct_alist(size_t const n_parameters, ...);
...
static void test_arraylist(void) {
    ...
    all_tests_pass &= test_arraylist_add_alist();
    all_tests_pass &= test_arraylist_addAll_alist();
    all_tests_pass &= test_arraylist_addAllN_alist();
    all_tests_pass &= test_arraylist_addDup_alist();
    all_tests_pass &= test_arraylist_addDupFirst_alist();
    all_tests_pass &= test_arraylist_addDupFirstN_alist();
    all_tests_pass &= test_arraylist_addDupFirstSameN_alist();
    all_tests_pass &= test_arraylist_addDupLast_alist();
    all_tests_pass &= test_arraylist_addDupLastN_alist();
    all_tests_pass &= test_arraylist_addDupLastSameN_alist();
    all_tests_pass &= test_arraylist_addDupN_alist();
    all_tests_pass &= test_arraylist_addDupSameN_alist();
    all_tests_pass &= test_arraylist_addF_alist();
    all_tests_pass &= test_arraylist_addIndeterminate_alist();
    all_tests_pass &= test_arraylist_addIndeterminateN_alist();
    all_tests_pass &= test_arraylist_addN_alist();
    all_tests_pass &= test_arraylist_addSameN_alist();
    all_tests_pass &= test_arraylist_addZeros_alist();
    all_tests_pass &= test_arraylist_addZerosN_alist();
    all_tests_pass &= test_arraylist_bsearch_alist();
    all_tests_pass &= test_arraylist_concat_alist();
    all_tests_pass &= test_arraylist_concatN_alist();
    all_tests_pass &= test_arraylist_construct_alist();
    all_tests_pass &= test_arraylist_constructEmpty_alist();
    all_tests_pass &= test_arraylist_delete_alist();
    all_tests_pass &= test_arraylist_deleteAll_alist();
    all_tests_pass &= test_arraylist_deleteFirst_alist();
    all_tests_pass &= test_arraylist_deleteFirstN_alist();
    all_tests_pass &= test_arraylist_deleteLast_alist();
    all_tests_pass &= test_arraylist_deleteLastN_alist();
    all_tests_pass &= test_arraylist_deleteN_alist();
    all_tests_pass &= test_arraylist_destruct_alist();
    all_tests_pass &= test_arraylist_flush_alist();
    all_tests_pass &= test_arraylist_get_alist();
    all_tests_pass &= test_arraylist_getFirst_alist();
    all_tests_pass &= test_arraylist_getFirstN_alist();
    all_tests_pass &= test_arraylist_getLast_alist();
    all_tests_pass &= test_arraylist_getLastN_alist();
    all_tests_pass &= test_arraylist_getN_alist();
    all_tests_pass &= test_arraylist_insert_alist();
    all_tests_pass &= test_arraylist_insertDup_alist();
    all_tests_pass &= test_arraylist_insertDupN_alist();
    all_tests_pass &= test_arraylist_insertDupSameN_alist();
    all_tests_pass &= test_arraylist_insertIndeterminate_alist();
    all_tests_pass &= test_arraylist_insertIndeterminateN_alist();
    all_tests_pass &= test_arraylist_insertN_alist();
    all_tests_pass &= test_arraylist_insertSameN_alist();
    all_tests_pass &= test_arraylist_insertZeros_alist();
    all_tests_pass &= test_arraylist_insertZerosN_alist();
    all_tests_pass &= test_arraylist_isAllocated_alist();
    all_tests_pass &= test_arraylist_isSorted_alist();
    all_tests_pass &= test_arraylist_isValid_alist();
    all_tests_pass &= test_arraylist_lsearch_alist();
    all_tests_pass &= test_arraylist_peek_alist();
    all_tests_pass &= test_arraylist_peekBottom_alist();
    all_tests_pass &= test_arraylist_peekBottomN_alist();
    all_tests_pass &= test_arraylist_peekN_alist();
    all_tests_pass &= test_arraylist_peekTop_alist();
    all_tests_pass &= test_arraylist_peekTopN_alist();
    all_tests_pass &= test_arraylist_pop_alist();
    all_tests_pass &= test_arraylist_popBottom_alist();
    all_tests_pass &= test_arraylist_popBottomN_alist();
    all_tests_pass &= test_arraylist_popN_alist();
    all_tests_pass &= test_arraylist_popTop_alist();
    all_tests_pass &= test_arraylist_popTopN_alist();
    all_tests_pass &= test_arraylist_push_alist();
    all_tests_pass &= test_arraylist_pushBottom_alist();
    all_tests_pass &= test_arraylist_pushBottomN_alist();
    all_tests_pass &= test_arraylist_pushBottomSameN_alist();
    all_tests_pass &= test_arraylist_pushIndeterminate_alist();
    all_tests_pass &= test_arraylist_pushIndeterminateBottom_alist();
    all_tests_pass &= test_arraylist_pushIndeterminateBottomN_alist();
    all_tests_pass &= test_arraylist_pushIndeterminateN_alist();
    all_tests_pass &= test_arraylist_pushIndeterminateTop_alist();
    all_tests_pass &= test_arraylist_pushIndeterminateTopN_alist();
    all_tests_pass &= test_arraylist_pushN_alist();
    all_tests_pass &= test_arraylist_pushSameN_alist();
    all_tests_pass &= test_arraylist_pushTop_alist();
    all_tests_pass &= test_arraylist_pushTopN_alist();
    all_tests_pass &= test_arraylist_pushTopSameN_alist();
    all_tests_pass &= test_arraylist_pushZeros_alist();
    all_tests_pass &= test_arraylist_pushZerosBottom_alist();
    all_tests_pass &= test_arraylist_pushZerosBottomN_alist();
    all_tests_pass &= test_arraylist_pushZerosN_alist();
    all_tests_pass &= test_arraylist_pushZerosTop_alist();
    all_tests_pass &= test_arraylist_pushZerosTopN_alist();
    all_tests_pass &= test_arraylist_qsort_alist();
    all_tests_pass &= test_arraylist_remove_alist();
    all_tests_pass &= test_arraylist_removeAll_alist();
    all_tests_pass &= test_arraylist_removeFirst_alist();
    all_tests_pass &= test_arraylist_removeFirstN_alist();
    all_tests_pass &= test_arraylist_removeLast_alist();
    all_tests_pass &= test_arraylist_removeLastN_alist();
    all_tests_pass &= test_arraylist_removeN_alist();
    all_tests_pass &= test_arraylist_reverse_alist();
    all_tests_pass &= test_arraylist_rotate_alist();
    all_tests_pass &= test_arraylist_rotateDown_alist();
    all_tests_pass &= test_arraylist_rotateDownN_alist();
    all_tests_pass &= test_arraylist_rotateN_alist();
    all_tests_pass &= test_arraylist_rotateUp_alist();
    all_tests_pass &= test_arraylist_rotateUpN_alist();
    all_tests_pass &= test_arraylist_set_alist();
    all_tests_pass &= test_arraylist_setAll_alist();
    all_tests_pass &= test_arraylist_setAllSame_alist();
    all_tests_pass &= test_arraylist_setAllZeros_alist();
    all_tests_pass &= test_arraylist_setDup_alist();
    all_tests_pass &= test_arraylist_setDupN_alist();
    all_tests_pass &= test_arraylist_setDupSameN_alist();
    all_tests_pass &= test_arraylist_setFirst_alist();
    all_tests_pass &= test_arraylist_setFirstN_alist();
    all_tests_pass &= test_arraylist_setFirstSameN_alist();
    all_tests_pass &= test_arraylist_setLast_alist();
    all_tests_pass &= test_arraylist_setLastN_alist();
    all_tests_pass &= test_arraylist_setLastSameN_alist();
    all_tests_pass &= test_arraylist_setN_alist();
    all_tests_pass &= test_arraylist_setSameN_alist();
    all_tests_pass &= test_arraylist_setZeros_alist();
    all_tests_pass &= test_arraylist_setZerosN_alist();
    all_tests_pass &= test_arraylist_swap_alist();
    all_tests_pass &= test_arraylist_swapN_alist();
    all_tests_pass &= test_arraylist_vconstruct_alist(2, sizeof(int), 1000000);
...
static bool test_arraylist_add_alist(void) {
    ...
    constructEmpty_alist(list, (size_t)5, (uint32_t)1);
...
static bool test_arraylist_addF_alist(void) {
    ...
    constructEmpty_alist(list, 6, 10);
...
static bool test_arraylist_insert_alist(void) {
    ArrayList list[1] = { NOT_AN_ALIST };
    constructEmpty_alist(list, 1, 1024);
...
static bool test_arraylist_pop_alist(void) {
    ...
    ArrayList list[1]   = { NOT_AN_ALIST };
    constructEmpty_alist(list, sizeof(int), n);
...
static bool test_arraylist_push_alist(void) {
    ...
    constructEmpty_alist(list, 1, n);
    constructEmpty_alist(rlist, 1, n);
...
static bool test_arraylist_pushBottomSameN_alist(void) {
    ArrayList list[1] = { NOT_AN_ALIST };
    constructEmpty_alist(list, 1, 10);
...
static bool test_arraylist_pushZeros_alist(void) {
    ArrayList list[1]   = { NOT_AN_ALIST };
    constructEmpty_alist(list, sizeof(int), 2);
...
static bool test_arraylist_setFirst_alist(void) {
    ...
    setFirst_alist(list, grades);
    TEST_FAIL_IF(*(int*)getFirst_alist(list) != grades[0])
...
static bool test_arraylist_setLast_alist(void) {
    ...
    setLast_alist(list, grades);
    TEST_FAIL_IF(*(int*)getLast_alist(list) != grades[0])
...
static bool test_arraylist_swap_alist(void) {
    ...
    ArrayList list[1] = { NOT_AN_ALIST };
    constructEmpty_alist(list, 1, word_len);
